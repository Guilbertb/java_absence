...
{ 
  ...
  for(e = 0;e<30;e++)
   { for(h = 0;h<20;h++)
    ...
    //JScrollPane contenu = getScrollPane() ;
    //JScrollPane contenu = new JScrollPane(channelSummaryTable);
    //JScrollPane contenu = new JScrollPane();
    //contenu.setVerticalScrollBar(contenu.createVerticalScrollBar());

    contenu.setLayout (new GridLayout(20,10)) ;
    //contenu.ScrollPaneLayout (new GridLayout(20,10)) ;
